...
import meetOutImg from '../meet-out.png';
import ludoImg from '../ludo.png';
import yashYogaImg from '../yash-yoga.png';
...
const Projects = props => {
    ...
    let myProjects = projects.map( (project, index) => {
        return (
                <PortfolioCard key={index} function={project.function} typeStyle={props.typeStyle} commentStyle={props.commentStyle} name={project.name} skills={project.skills} description={project.description} features={project.features} github={project.github} deployed={project.deployed} image={project.image} />
        )
    })
